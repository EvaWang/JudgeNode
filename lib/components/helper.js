...
module.exports = {
	canReadAns: function(sid, uid){
		return new Promise(function(resolve, reject) {
			var cmd = 'select distinct uid from submissions where sid = ? and (uid =? or (select uid from users where class is NULL and uid =?) is not null )';
			connection.query(cmd, [sid, uid, uid], function(err, result) {
